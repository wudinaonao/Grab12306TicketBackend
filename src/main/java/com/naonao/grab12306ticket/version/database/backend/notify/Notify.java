package com.naonao.grab12306ticket.version.database.backend.notify;

import com.naonao.grab12306ticket.version.database.backend.common.AbstractBackend;
import com.naonao.grab12306ticket.version.database.backend.constants.NotifyMethodName;
import com.naonao.grab12306ticket.version.database.backend.database.table.NotifyInformationTable;
import com.naonao.grab12306ticket.version.database.backend.notify.common.AbstractNotify;
import com.naonao.grab12306ticket.version.database.backend.notify.email.Email;
import com.naonao.grab12306ticket.version.database.backend.notify.phone.Phone;
import com.naonao.grab12306ticket.version.database.backend.notify.sms.SMS;
...
public class Notify extends AbstractNotify {
    ...
    public Notify(){
        ...
        if (properties == null){
            log.error(AbstractBackend.READ_CONFIG_FAILED);
        }
    }
