package com.naonao.grab12306ticket.version.database.backend.database.methodclass;

import com.naonao.grab12306ticket.version.database.backend.database.common.AbstractDatabase;
import com.naonao.grab12306ticket.version.database.backend.tools.GeneralTools;
import com.naonao.grab12306ticket.version.database.backend.database.mapper.GrabTicketInformationMapper;
import com.naonao.grab12306ticket.version.database.backend.database.mapper.NotifyInformationMapper;
import com.naonao.grab12306ticket.version.database.backend.database.mapper.StatusInformationMapper;
import com.naonao.grab12306ticket.version.database.backend.database.mapper.UserInformationMapper;
 ...
 **/
@Log4j
public class Insert extends AbstractDatabase {
    ...
    public void userInformation(UserInformationTable userInformationTable){
        ...
        try{
            ...
            userInformationMapper.insert(userInformationTable);
            session.commit();
    ...
    public void grabTicketInformation(GrabTicketInformationTable grabTicketInformationTable){
        ...
        try{
            ...
            grabTicketInformationMapper.insert(grabTicketInformationTable);
            session.commit();
        }catch (PersistenceException e){
            return;
        } finally{
    ...
    public void notifyInformation(NotifyInformationTable notifyInformationTable){
        ...
        try{
            ...
            notifyInformationMapper.insert(notifyInformationTable);
            session.commit();
        }catch (PersistenceException e){
            return;
        } finally{
    ...
    public void statusInformation(StatusInformationTable statusInformationTable){
        ...
        try{
            ...
            statusInformationMapper.insert(statusInformationTable);
            session.commit();
        }catch (PersistenceException e){
            return;
        } finally{
